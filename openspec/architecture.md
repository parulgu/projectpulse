...
### ADR-001 Project Scoping
All actions, notes, bugs, decisions, milestones, and links belong to a project.
Reason:
Prevents cross-project contamination.

### ADR-002 Human Review Before Persistence
AI-generated actions are never automatically saved.
Reason:
Maintains user trust and accuracy.
